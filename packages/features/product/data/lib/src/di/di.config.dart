...
_i174.GetIt init(
  ...
  final productDataModule = _$ProductDataModule();
  gh.factory<_i788.ProductApiClient>(
    () => productDataModule.productApiClient(gh<_i372.Dio>()),
  );
...
class _$ProductDataModule extends _i913.ProductDataModule {}
